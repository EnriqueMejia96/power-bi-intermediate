...
## Qué se aprende
En este documento se aprende a crear datos realistas sin exponer información real. El foco es que el estudiante pueda tomar una decisión de diseño BI y explicar por qué esa decisión mejora la confiabilidad del análisis.
...
## Aplicación práctica
Para este tema, la práctica consiste en entender problemas controlados de calidad. El estudiante debe usar el diccionario de datos y seleccionar hechos/dimensiones que respondan una pregunta concreta.
