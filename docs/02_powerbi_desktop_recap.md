# Recap Power BI Desktop

## Qué se aprende
En este documento se aprende a ubicar las vistas y componentes esenciales. El foco es que el estudiante pueda tomar una decisión de diseño BI y explicar por qué esa decisión mejora la confiabilidad del análisis.
...
## Aplicación práctica
Para este tema, la práctica consiste en navegar Desktop con intención técnica. El estudiante debe usar el diccionario de datos y seleccionar hechos/dimensiones que respondan una pregunta concreta.
