# Arquitectura analítica Power BI

## Qué se aprende
En este documento se aprende a entender Power BI como arquitectura de decisiones. El foco es que el estudiante pueda tomar una decisión de diseño BI y explicar por qué esa decisión mejora la confiabilidad del análisis.
...
## Aplicación práctica
Para este tema, la práctica consiste en definir capas, responsabilidades y flujo de valor. El estudiante debe usar el diccionario de datos y seleccionar hechos/dimensiones que respondan una pregunta concreta.
