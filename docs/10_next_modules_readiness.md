...
## Qué se aprende
En este documento se aprende a conectar Módulo 1 con el resto del programa. El foco es que el estudiante pueda tomar una decisión de diseño BI y explicar por qué esa decisión mejora la confiabilidad del análisis.
...
## Aplicación práctica
Para este tema, la práctica consiste en dejar pendientes bien delimitados. El estudiante debe usar el diccionario de datos y seleccionar hechos/dimensiones que respondan una pregunta concreta.
